...
<p>The model was created with the script <a href=\"modelica://SMArtInt/Resources/ExampleNeuralNets/PIController/PI.py\">ExampleNeuralNets\\PIController\\PI.py</a> with setting rnn_type = RnnType.RNN in line 78.</p>
