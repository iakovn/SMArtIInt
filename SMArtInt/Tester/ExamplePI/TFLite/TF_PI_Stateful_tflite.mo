...
model TF_PI_Stateful_tflite
  ...
  Blocks.EvaluateStatefulRecurrentNeuralNet controller(pathToTfLiteFile=Modelica.Utilities.Files.loadResource("modelica://SMArtInt/Resources/ExampleNeuralNets/PIController/PI_stateful.tflite"),
                                                                                                                                                                                                 samplePeriod=10)   annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
equation
...
<p>The model was created with the script <a href=\"modelica://SMArtInt/Resources/ExampleNeuralNets/PIController/PI.py\">ExampleNeuralNets\\PIController\\PI.py</a> with setting rnn_type = RnnType.EXTSTATE in line 78. This </p>
